...
{
    horizontalSlider->setRange(100,255);
...
void KeyBoard::onCapslock()
{
    ...
    if(caps_Lock)
    {
        ...
        /*    toolButton_line1->setText("/");
            ...
            toolButton_dot->setText(".");
            toolButton_wenhao->setText("?"); */
            toolButton_1->setText("`");
            toolButton_2->setText("~");
            toolButton_3->setText("@");
            toolButton_4->setText("#");
            toolButton_5->setText("$");
            toolButton_6->setText("^");
            toolButton_7->setText("+");
            toolButton_8->setText("*");
            toolButton_9->setText(";");
            toolButton_0->setText(":");
    }
    else
    {
        //letter
